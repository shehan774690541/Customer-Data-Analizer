...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Apr 23, 2023 at 06:56 PM
...
INSERT INTO `cart` (`ID`, `Ithem`, `Brand`, `IthemCount`, `I_index`) VALUES
(5, 'Intel(R) Core(TM) i5-3470 CPU @ 3.20GHz   3.20 GHz', 'intel', 1, 1),
(9, 'DDR3 4GB', 'RAM', 1, 2),
(4, 'UPS', 'SCP', 1, 3),
(9, 'DDR3 4GB', 'RAM', 1, 4),
(2, 'LCD Monitor (1024x1280)', 'Dell', 1, 5),
(13, 'calculatore', 'deli', 1, 6),
(6, '500GB HDD', 'THOSHIBA', 1, 7),
(4, 'UPS', 'SCP', 1, 8),
(8, 'DDR 3 2GB ', 'RAM', 1, 9),
(3, 'K6010 Wired Keyboard', 'DELUX', 1, 10),
(9, 'DDR3 4GB', 'RAM', 1, 11),
(10, 'GT620 VGA', 'NVDIA', 1, 12),
(5, 'Intel(R) Core(TM) i5-3470 CPU @ 3.20GHz   3.20 GHz', 'intel', 1, 13),
(6, '500GB HDD', 'THOSHIBA', 1, 14);
...
(1, 'LED monitor (1600x900)', 'LG', 5000, 0, 7),
